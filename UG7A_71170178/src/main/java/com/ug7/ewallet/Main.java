...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71170178 = new User("Ade Putri", "ade.putri@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71170178 = new GoPay(U_71170178);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71170178.getUser().getNama()+"] - ");
        E_71170178.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71170178.getUser().getNama()+"] - ");
        E_71170178.topup(50000);
        System.out.print("["+E_71170178.getUser().getNama()+"] - ");
        E_71170178.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71170178, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71170178.getUser().getNama()+"] - ");
        E_71170178.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71170178.getUser().getNama()+"] - ");
        E_71170178.withdraw(1100);
