...
public class eWallet {
    ...
    public void topup(int jumlah) {
        ...
        if(this.user.getUang() < jumlah) {
            System.out.println("jmlh cash tidak mencukupi! ("+formatRupiah(this.user.getUang()-jumlah)+")");
            return;
        }
    ...
    public void pay(int jumlah) {
        ...
        if(jumlah > this.saldo) {
            System.out.println("saldo anda tidak cukup ("+formatRupiah(this.saldo-jumlah)+")");
            return;
        }
        this.saldo -= jumlah;
    }
    ...
    public void transfer(eWallet eWallet, int jumlah) {
        ...
        if(jumlah > this.saldo) {
            System.out.println("Maaf, saldo kamu tidak mencukupi! ("+formatRupiah(this.saldo-jumlah)+")");
            return;
        }
        this.saldo -= jumlah;
